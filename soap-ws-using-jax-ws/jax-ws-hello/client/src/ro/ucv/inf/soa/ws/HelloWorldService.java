 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://ws.soa.inf.ucv.ro/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://ws.soa.inf.ucv.ro/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://ws.soa.inf.ucv.ro/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.soa.inf.ucv.ro/", "HelloWorldPort"), HelloWorld.class, features);
    }
