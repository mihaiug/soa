 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://service.ws.soa.inf.ucv.ro/", wsdlLocation = "http://localhost:9090/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://service.ws.soa.inf.ucv.ro/", "Calculator");
    ...
    public CalculatorService getCalculatorServiceImplPort() {
        return super.getPort(new QName("http://service.ws.soa.inf.ucv.ro/", "CalculatorServiceImplPort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.soa.inf.ucv.ro/", "CalculatorServiceImplPort"), CalculatorService.class, features);
    }
